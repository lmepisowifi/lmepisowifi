...
function addPptpClient(obj)
{
	...
	if (document.pptp.c_name.value=="") {
		alert("<% multilang("2414" "LANG_PLEASE_ENTER_PPTP_CLIENT_RULE_NAME"); %>");
		document.pptp.c_name.focus();
		return false;
	}
...
<div class="btn_ctl">
	<input class="link_bg" type="submit" value="<% multilang("248" "LANG_DELETE_SELECTED"); %>" name="delSelAccount" onClick="return on_submit(this)">&nbsp;&nbsp;
	<input class="link_bg" type="submit" value="<% multilang("887" "LANG_SAVE"); %>" name="saveAccount" onClick="return on_submit(this)">
</div>
