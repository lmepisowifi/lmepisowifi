...
<% SendWebHeadStr();%>
<title><% multilang("303" "LANG_WLAN_EASY_MESH_VLAN_CONFIGURATION"); %></title>
<style>
.on {display:on}
.off {display:none}
...
<SCRIPT>
            ...
            function addMoreSSID(vlan_idx, secondary_vlan_idx, vid_ssid)
            {
                ...
                if ('PRIMARY' == vlan_idx) {
                    ...
                    ssid.innerHTML = '                    <font size=2>                    <select class="ssid_select" size="1" name="primary_ssid" onchange="rearrangeSelectOptions();">'
                        + tmp_html +
                        '</select>';
                    ssid.colSpan = 2;
                    ssid_deleted.innerHTML = '<td width="100%" style="text-align:right">			        <input type="button" id="delete_primary_ssid" name="delete_primary_ssid" value="- Delete SSID" onclick="deleteSSID(this)">			        </td>';
                    primary_ssid_nr++;
                    ...
                    var ssid_deleted = row.insertCell(1);
                    tmp_html = SetSSIDSettingOption(vid_ssid);
                    ssid.innerHTML = '                    <font size=2>                    <select class="ssid_select" size="1" name="secondary_ssid_'+ secondary_vlan_idx.toString() + '" onchange="rearrangeSelectOptions();">'
                        + tmp_html +
                        '</select>';
                    ssid.colSpan = 2;
                    ssid_deleted.innerHTML = '<td width="100%" style="text-align:right">			        <input type="button" id="delete_secondary_ssid_' + secondary_vlan_idx + '" name="delete_secondary_ssid_ ' + secondary_vlan_idx + '" value="- Delete SSID" onclick="deleteSSID(this)">			        </td>';
                    ...
                    var ssid_deleted = row.insertCell(1);
                    tmp_html = SetSSIDSettingOption(vid_ssid);
                    ssid.innerHTML = '                    <font size=2>                    <select class="ssid_select" size="1" name="default_secondary_ssid" onchange="rearrangeSelectOptions();">'
                        + tmp_html +
                        '</select>';
                    ssid.colSpan = 2;
                    ssid_deleted.innerHTML = '<td width="100%" style="text-align:right">			        <input type="button" id="delete_default_secondary_ssid" name="delete_default_secondary_ssid" value="- Delete SSID" onclick="deleteSSID(this)">			        </td>';
			        default_secondary_ssid_nr++;
                }
                rearrangeSelectOptions();
            }
            ...
            function addMoreSecondaryVLAN(sec_vid)
            {
                ...
                secondary_vlan_tbody.innerHTML = '                <tr style="background-color:#aaddff;">			        <td width="60%" style="padding: 0; margin: 0;"><font size=2><b>Guest Network '+ secondary_ssid_nr.length + '</b></td>			        <td width="30%" align="right" style="padding: 0; margin: 0;"><font size=2><b style="display:none">VID:</b></td>			        <td width="10%" style="padding: 0; margin: 0;">                        <input type="text" id="secondary_vid_text" name="secondary_vid_text" class="vid_number" style="display:none" value="' + ((0 == sec_vid) ? (secondary_vid_count * 10).toString() : sec_vid) + '">			</td>                </tr>                <tr>			        <td width="100%" colspan="3" style="text-align:right">                        <input type="button" id="add_secondary_ssid" name="add_secondary_ssid" value="+ Add more SSID" onclick="addMoreSSID(\'SECONDARY\', '+ secondary_ssid_nr.length + ')">			        </td>                </tr>                <tr>			        <td width="100%" colspan="3" style="text-align:right">                        <input type="button" id="delete_secondary_vlan" name="delete_secondary_vlan" align="right" style="font-weight:bold;" value="- Delete Guest Network" onclick="deleteSecondaryVLAN(this)">			        </td>                </tr>';
    ...
    <body onload="loadInfo();">
        <div class="intro_main ">
	            <p class="intro_title"><% multilang("303" "LANG_WLAN_EASY_MESH_VLAN_CONFIGURATION"); %></p>
	            <p class="intro_content"><% multilang("304" "LANG_WLAN_EASY_MESH_VLAN_CONFIGURATION_DESC"); %></p>
        </div>
    ...
    <form action=/boaform/formMultiAPVLAN method=POST name="MultiAPVLAN">
            <div class="data_common data_common_notitle">
                    ...
                    <tr>
                        <th width="100%" colspan=3>
                                    <input type="checkbox" id="enable_vlan" value="OFF"
                                        onclick="enableVLANOnClick()">&nbsp;&nbsp;<% multilang("3317" "LANG_EASYMESH_ENABLE_GUEST_NETWORK"); %>
                        </th>
                    </tr>
                ...
                <div class="btn_ctl">
                    <input type="submit" value="<% multilang("169" "LANG_APPLY_CHANGES"); %>" class="link_bg" name="save_apply" onClick="return saveChanges(this)">&nbsp;&nbsp;
                    <input type="reset" value="<% multilang("246" "LANG_RESET"); %>" class="link_bg" name="reset" onClick="resetClick()">
