...
<%SendWebHeadStr(); %>
<title><% multilang("52" "LANG_OMCI_INFO"); %></title>
...
<div class="intro_main ">
	<p class="intro_title"><% multilang("52" "LANG_OMCI_INFO"); %></p>
</div>
...
<table>
	<tr>
		<th><% multilang("64" "LANG_OMCI_VENDOR_ID"); %>:</th>
		<td><input type="text" name="omci_vendor_id" size="14" maxlength="4"></td>
	</tr>
	<tr>
		<th><% multilang("58" "LANG_OMCI_SW_VER1"); %>:</th>
		<td>
	...
	<tr>
		<th><% multilang("59" "LANG_OMCI_SW_VER2"); %>:</th>
		<td>
	...
	<tr>
		<th><% multilang("60" "LANG_OMCC_VER"); %>:</th>
	...
	<tr>
		<th><% multilang("61" "LANG_OMCI_TM_OPT"); %>:</th>
	...
	<tr>
		<th><% multilang("62" "LANG_OMCI_EQID"); %>:</th>
		<td>
	...
	<tr>
		<th><% multilang("63" "LANG_OMCI_ONT_VER"); %>:</th>
		<td>
