...
<div class="data_common data_common_notitle">
	<table>
	  <tr>
		  ...
		  <td>
	      	<input type="radio" value="0" name="clientlimitenable" onChange="clickenable()"><% multilang("201" "LANG_DISABLED"); %>&nbsp;&nbsp;
	     	<input type="radio" value="1" name="clientlimitenable" onChange="clickenable()"><% multilang("200" "LANG_ENABLED"); %>
	      </td>
