...
<title><% multilang("26" "LANG_MLD_PROXY"); %><% multilang("262" "LANG_CONFIGURATION"); %></title>
<SCRIPT>
var robust_count=0;
...
<div class="intro_main ">
	<p class="intro_title"><% multilang("26" "LANG_MLD_PROXY"); %> <% multilang("262" "LANG_CONFIGURATION"); %></p>
	<p class="intro_content"><% multilang("452" "LANG_THIS_PAGE_BE_USED_TO_CONFIGURE_MLD_PROXY"); %></p>
</div>
	...
	<div class="data_common data_common_notitle">			
		<table>
			<tr id="proxy_enable">
				...
				<td>
				<input type="radio" value="0" name="daemon" <% checkWrite("mldproxy0"); %> onClick="proxySelection()"><% multilang("271" "LANG_DISABLE"); %>&nbsp;&nbsp;
				<input type="radio" value="1" name="daemon" <% checkWrite("mldproxy1"); %> onClick="proxySelection()"><% multilang("272" "LANG_ENABLE"); %></td>
			</tr>
			<tr id="proxy_wan_if">
				<th><% multilang("454" "LANG_WAN_INTERFACE"); %>:&nbsp;</th>
				<td><select name="ext_if" <% checkWrite("mldproxy0d"); %>> <% if_wan_list("rtv6"); %> </select> </td>
			</tr>
			<tr>
				<th><% multilang("3306" "LANG_MLD_ROBUST_COUNT"); %>:</th>
				<td>
					<input type="text" name="mld_robust_count" size="10" maxlength="15">
				</td>
			</tr>
			<tr>
				<th><% multilang("3308" "LANG_MLD_QUERY_INTERVAL"); %>:</th>
				<td>
					<input type="text" name="mld_query_interval" size="10" maxlength="15">(Second)
				</td>
			</tr>
			<tr>
				<th><% multilang("3309" "LANG_MLD_QUERY_RESPONSE_INTERVAL"); %>:</th>
				<td>
					<input type="text" name="mld_query_response_interval" size="10" maxlength="15">(millisecond)
				</td>
			</tr>
			<tr>
				<th><% multilang("3307" "LANG_MLD_RESPONSE_LAST_GROUP_MEMBER_INTERVAL"); %>:</th>
				<td>
