...
<% SendWebHeadStr();%>
<title>UPnP <% multilang("262" "LANG_CONFIGURATION"); %></title>
<SCRIPT>
...
<div class="intro_main ">
	<p class="intro_title">UPnP <% multilang("262" "LANG_CONFIGURATION"); %></p>
	<p class="intro_content"><% multilang("456" "LANG_THIS_PAGE_IS_USED_TO_CONFIGURE_UPNP_THE_SYSTEM_ACTS_AS_A_DAEMON_WHEN_YOU_ENABLE_IT_AND_SELECT_WAN_INTERFACE_UPSTREAM_THAT_WILL_USE_UPNP"); %></p>
</div>
...
<div class="data_common data_common_notitle">
	<table>
		<tr>
			<th width="30%"><% multilang("30" "LANG_UPNP"); %>:</th>
			<td>
				<input type="radio" value="0" name="daemon" <% checkWrite("upnp0"); %> onClick="proxySelection()"><% multilang("271" "LANG_DISABLE"); %>&nbsp;&nbsp;
				<input type="radio" value="1" name="daemon" <% checkWrite("upnp1"); %> onClick="proxySelection()"><% multilang("272" "LANG_ENABLE"); %>
			</td>
		</tr>
...
<div class="btn_ctl">
	<input type="submit" value="<% multilang("169" "LANG_APPLY_CHANGES"); %>" class="link_bg" onClick="return on_submit(this)">
...
<div class="column">
	<div class="column_title">
		...
		<p>UPnP <% multilang("431" "LANG_CURRENT_PORT_FORWARDING_TABLE"); %></p>
