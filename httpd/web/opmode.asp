...
function countDown_start(){	
	...
	if(time >= 0){
		...
		document.cntdown_frm.cntdwn_text.value = "<% multilang("3122" "LANG_PLEASE_WAIT_FOR_CONFIGURING_OPMODE"); %>";
...
<BODY onLoad="on_init();">
	<div class="intro_main ">
		<p class="intro_title"><% multilang("3116" "LANG_OPERATION_MODE"); %></p>
		<p class="intro_content"><% multilang("3119" "LANG_PAGE_DESC_CONFIGURE_INTERNET_OP_MODE_SETTING"); %></p>
	</div>
<div id="opmode_div">
...
<div class="data_common data_common_notitle">
	<table>
		<tr>
			<th><% multilang("3116" "LANG_OPERATION_MODE"); %>:</th>
			<td>
      ...
      <input type="button" value="<% multilang("169" "LANG_APPLY_CHANGES"); %>" name="save" onClick="return saveChanges()">&nbsp;&nbsp;
