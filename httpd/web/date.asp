...
<%SendWebHeadStr(); %>
<title><% multilang("855" "LANG_SYSTEM_DATE_AND_TIME_MODIFICATION"); %></title>
<SCRIPT>
function on_submit()
{
...
<div class="intro_main ">
	<p class="intro_title"><% multilang("855" "LANG_SYSTEM_DATE_AND_TIME_MODIFICATION"); %></p>
	<p class="intro_content"> <% multilang("856" "LANG_SET_THE_SYSTEM_DATE_AND_TIME"); %></p>
</div>
...
<div class="data_common data_common_notitle">
	<table>
		<tr>
	      <th width=30%><font size=2><b><% multilang("82" "LANG_DATE"); %>:</b></td>
	      <td width=70%>
	  ...
	  <tr>
	      <th width=30%><font size=2><b><% multilang("83" "LANG_TIME"); %>:</b></td>
	      <td width=70%>
	  ...
	  <tr>
	      <th width=30%><font size=2><b><% multilang("74" "LANG_TIME_ZONE"); %>:</b></td>
	      <td width=70%>
	      	<select name="sys_tz">
...
<div class="btn_ctl">
	...
	<input class="link_bg" type="submit" value="<% multilang("857" "LANG_SUBMIT"); %>" name="set" onClick="return on_submit()">&nbsp;&nbsp;
	<input class="link_bg" type="button" value="<% multilang("708" "LANG_CANCEL"); %>" name="close" onClick="javascript: window.close();">
