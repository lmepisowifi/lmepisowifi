...
<%SendWebHeadStr(); %>
<TITLE>IP QoS <% multilang("44" "LANG_TRAFFIC_SHAPING"); %></TITLE>
...
<div class="intro_main ">
	<p class="intro_title">IP QoS <% multilang("44" "LANG_TRAFFIC_SHAPING"); %></p>
</div>
...
<div class="data_vertical data_common_notitle">
	 <div class="data_common ">
		<table id="traffictl_tbl" >
			   <tr>
					<th><% multilang("722" "LANG_ID"); %></th>
					<th><% multilang("101" "LANG_PROTOCOL"); %></th>
					<th><% multilang("421" "LANG_SOURCE_PORT"); %></th>
					<th><% multilang("422" "LANG_DESTINATION_PORT"); %></th>
					<th><% multilang("418" "LANG_SOURCE"); %> IP</th>
					<th><% multilang("419" "LANG_DESTINATION"); %> IP</th>
					<th style="display:<% check_display("vlanID"); %>"><% multilang("141" "LANG_VLAN_ID"); %></th>						
					<th style="display:<% check_display("ssid"); %>"><% multilang("153" "LANG_SSID"); %></th>						
					<th><% multilang("692" "LANG_RATE"); %>(kb/s)</th>
					<th><% multilang("335" "LANG_DELETE"); %></th>
					<th>IP <% multilang("727" "LANG_VERSION"); %></th>
	                <th><% multilang("414" "LANG_DIRECTION"); %></th>
					<th><div id='wan_interface'><% multilang("454" "LANG_WAN_INTERFACE"); %></div></th>
				</tr>
		</table>
	</div>
</div>
<div class="btn_ctl">
	<table>
		<tr>
			<td><input class="link_bg" type="button" onClick="location.href='net_qos_traffictl_edit.asp';" value="<% multilang("245" "LANG_ADD"); %>"></td>
			<td><input class="link_bg" type="button" onClick="on_submit();" value="<% multilang("169" "LANG_APPLY_CHANGES"); %>"></td>
		</tr>
	</table>
</div>
