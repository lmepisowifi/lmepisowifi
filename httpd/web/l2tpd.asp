...
function checkTextStr(obj)
{
	if(obj.value.length > 30){		
		alert('<% multilang("2323" "LANG_LENGTH_SHOULD_LESS_THEN_32"); %>');
		obj.focus();
		return false;
	}
	...
	for (var i=0; i<obj.value.length; i++) 
	{
		...
		{			
			alert('<% multilang("2324" "LANG_INVALID_CHARACTER_IN_TEXT_AERA"); %>');
			obj.focus();
			return false;
		}
	}
...
function addL2tpClient(obj)
{
	...
	if (document.l2tp.mtu.value=="") {               
		alert('<% multilang("2332" "LANG_PLEASE_ENTER_L2TP_CLIENT_MTU"); %>');
	...
	<div class="data_common">
		<table>
			<tr>
				...
				<th align=center width="5%"><% multilang("1261" "LANG_TUNNEL_AUTH"); %></th>
				<th align=center width="5%"><% multilang("1262" "LANG_PPP_AUTH"); %></th>
...
<div class="btn_ctl">
	<input class="link_bg" type="submit" value="<% multilang("248" "LANG_DELETE_SELECTED"); %>" name="delSelClient" onClick="return on_submit(this)">&nbsp;&nbsp;
