...
<% SendWebHeadStr();%>
<title>Ping6 <% multilang("46" "LANG_DIAGNOSTICS"); %></title>
<SCRIPT>
...
<div class="intro_main ">
	<p class="intro_title">Ping6 <% multilang("46" "LANG_DIAGNOSTICS"); %></p>
	<p class="intro_content">   <% multilang("521" "LANG_PAGE_DESC_ICMPV6_DIAGNOSTIC"); %></p>
</div>
...
<div class="btn_ctl">
	...
	<input id="pingSubmit" class="link_bg" type="submit" value="<% multilang("541" "LANG_START"); %>" name="go" onClick="return goClick(this)">
