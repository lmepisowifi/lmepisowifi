...
<title><% multilang("106" "LANG_LAN_PORT_STATUS"); %></title>
...
<div class="intro_main ">
	<p class="intro_title"><% multilang("106" "LANG_LAN_PORT_STATUS"); %></p>
	<p class="intro_content"> <% multilang("107" "LANG_THIS_PAGE_SHOWS_THE_CURRENT_LAN_PORT_STATUS"); %></p>
</div>
...
<div class="column">
	<div class="column_title">
		<div class="column_title_left"></div>
			<p><% multilang("106" "LANG_LAN_PORT_STATUS"); %></p>
