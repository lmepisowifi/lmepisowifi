...
<%SendWebHeadStr(); %>
<title><% multilang("125" "LANG_802_1X_TITLE"); %> </title>
...
<div class="intro_main ">
	<p class="intro_title"><% multilang("125" "LANG_802_1X_TITLE"); %> </p>
	<p class="intro_content"> <% multilang("126" "LANG_SUPPORT_LAN_PORT_802_1X"); %></p>
</div>
...
<div class="column clearfix">
        <div class="column_title">
                ...
                <p><% multilang("262" "LANG_CONFIGURATION"); %></p>
...
<div class="column clearfix">
        <div class="column_title">
                <div class="column_title_left"></div>
                <p><% multilang("131" "LANG_PORT_TABLE"); %></p>
                <div class="column_title_right"></div>
        </div>
</div>
<div class="data_common">
<table>
	<tr>
                ...
                <th width="15%"><% multilang("132" "LANG_ADMINISTRATIVE_STATE"); %></th>
                <th width="15%"><% multilang("133" "LANG_PORT_STATE"); %></th>
	</tr>
	<tr>
                <td width="5">1</td>
                <td width="15%">
			<select name="admin_state">
				<option selected value ="0"><% multilang("134" "LANG_FORCE_AUTHORIZED"); %></option>
				<option value="1"><% multilang("191" "LANG_AUTO"); %></option>
			</select>
		</td>
