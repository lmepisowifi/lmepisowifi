...
function PFWApply(obj) {
   ...
   if (document.portfwAdvance.ip.value=="") {
	alert("<% multilang("2406" "LANG_LOCAL_IP_ADDRESS_CANNOT_BE_EMPTY"); %>");
   ...
   if (document.portfwAdvance.lstApply.options.length == 0) {
	alert("<% multilang("2407" "LANG_RULE_CANNOT_BE_EMPTY_PLEASE_CHOOSE_ONE_GATEGORY_AND_SELECT_ONE_AVAILABLE_RULE_THEN_ADD_INTO_APPLIED_RULE"); %>");
	return false;
   }
...
<div class="data_common data_common_notitle">
   <table>
      <tr>
          <th><% multilang("905" "LANG_CATEGORY"); %>: </th>
          <td>
...
<div class="data_common data_common_notitle">
	<table>
		...
		<tr>
			<th><% multilang("337" "LANG_LOCAL"); %> <% multilang("94" "LANG_IP_ADDRESS"); %>:</th>
			<td>
...
<div class="data_common data_common_notitle">
   <table>
      <tr>      
         <th><% multilang("906" "LANG_AVAILABLE_RULES"); %></th>
         <td></td>
         <th><% multilang("907" "LANG_APPLIED_RULES"); %></th>
      </tr>      
      <tr>
         <td>
...
<div class="btn_ctl">     
	<input class="link_bg" type=submit value="<% multilang("245" "LANG_ADD"); %>" name="save" onClick="return PFWApply(this)">&nbsp;&nbsp;
</div>     

<div class="column">
	<div class="column_title">
		<div class="column_title_left"></div>
			<p><% multilang("908" "LANG_PORT_FORWARDING_ADVANCE_TABLE"); %></p>
...
<div class="btn_ctl"> 
   ...
   <input class="link_bg" type="submit" value="<% multilang("248" "LANG_DELETE_SELECTED"); %>" name="delRule" onClick="return on_submit(this)">&nbsp;&nbsp;  
   <input class="link_bg" type="submit" value="<% multilang("249" "LANG_DELETE_ALL"); %>" name="delAllRule" onClick="return deleteAllClick(this)">&nbsp;&nbsp;&nbsp;
