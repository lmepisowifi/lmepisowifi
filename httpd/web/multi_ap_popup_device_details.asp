...
<% SendWebHeadStr();%>
<title><% multilang("297" "LANG_WLAN_EASY_MESH_DEVICE_DETAILS"); %></title>
<style>
.on {display:on}
.off {display:none}
</style>
...
function loadInfo() {
    ...
    nbTableHtmlString += '<tr><th width="80"><% multilang("97" "LANG_MAC_ADDRESS"); %></th><th width="100"><% multilang("724" "LANG_NAME"); %></th><th width="60">RSSI</th><th width="55"><% multilang("3324" "LANG_EASYMESH_CONNECTED_BAND"); %></th></tr>';
    staTableHtmlString += '<tr><th width="80"><% multilang("97" "LANG_MAC_ADDRESS"); %></th><th width="30">RSSI</th><th width="55"><% multilang("3324" "LANG_EASYMESH_CONNECTED_BAND"); %></th><th width="60"><% multilang("3325" "LANG_EASYMESH_DOWNLINK"); %></th><th width="60"><% multilang("3326" "LANG_EASYMESH_UPLINK"); %></th></tr>';
...
<div class="intro_main ">
	<p class="intro_title"><% multilang("297" "LANG_WLAN_EASY_MESH_DEVICE_DETAILS"); %></p>
	<p class="intro_content"><% multilang("298" "LANG_WLAN_EASY_MESH_DEVICE_DETAILS_DESC"); %></p>
</div>

<div class="column">
 <div class="column_title">
  <div class="column_title_left"></div>
   <p><% multilang("299" "LANG_WLAN_EASY_MESH_NEIGHBOR_RSSI"); %>:</p>
...
<div class="column">
 <div class="column_title">
  <div class="column_title_left"></div>
   <p><% multilang("300" "LANG_WLAN_EASY_MESH_STA_INFO"); %>:</p>
  <div class="column_title_right"></div>
</div>
...
<div class="btn_ctl">
  ...
  <input type="button" value="<% multilang("463" "LANG_REFRESH"); %>" class="link_bg" onclick="location.reload(true);">&nbsp;&nbsp;
  <input type="button" value="<% multilang("766" "LANG_CLOSE"); %>" class="link_bg" name="close" onClick="javascript: window.close();">
</div>
</form>
</body>
