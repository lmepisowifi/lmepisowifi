<%SendWebHeadStr(); %>
<title>IP/Port <% multilang("408" "LANG_FILTERING"); %></title>
...
<div class="intro_main ">
	<p class="intro_title">IP/Port <% multilang("408" "LANG_FILTERING"); %></p>
...
<div class="data_common data_common_notitle">
	<table>	
		<tr>
			...
			<td width="70%"><input type="radio" name="outAct" value=0 <% checkWrite("ipf_out_act0"); %>><% multilang("411" "LANG_DENY"); %>&nbsp;&nbsp;
				<input type="radio" name="outAct" value=1 <% checkWrite("ipf_out_act1"); %>><% multilang("412" "LANG_ALLOW"); %>&nbsp;&nbsp;
			</td>
		</tr>
		<tr>
			<th width="30%"><% multilang("413" "LANG_INCOMING_DEFAULT_ACTION"); %>:&nbsp;&nbsp;</th>
			<td width="70%"><input type="radio" name="inAct" value=0 <% checkWrite("ipf_in_act0"); %>><% multilang("411" "LANG_DENY"); %>&nbsp;&nbsp;
				<input type="radio" name="inAct" value=1 <% checkWrite("ipf_in_act1"); %>><% multilang("412" "LANG_ALLOW"); %>&nbsp;&nbsp;
			</td>
		</tr>
	</table>
</div>
...
<div class="data_common data_common_notitle">
	<table>	
		...
		<tr>
			<th>
				<% multilang("418" "LANG_SOURCE"); %> <% multilang("94" "LANG_IP_ADDRESS"); %>:  <input type="text" name="sip" size="10" maxlength="15">
			</th>
			<th>
				<% multilang("95" "LANG_SUBNET_MASK"); %>:  <input type="text" name="smask" size="10" maxlength="15">
			</th>
			<th>
				<% multilang("236" "LANG_PORT"); %>: 
		...
		<tr>
			<th>
				<% multilang("419" "LANG_DESTINATION"); %> <% multilang("94" "LANG_IP_ADDRESS"); %>:  <input type="text" name="dip" size="10" maxlength="15">
			</th>
			<th>
				<% multilang("95" "LANG_SUBNET_MASK"); %>:  <input type="text" name="dmask" size="10" maxlength="15">
			</th>
			<th>
				<% multilang("236" "LANG_PORT"); %>: 
