...
<% SendWebHeadStr();%>
<title><% multilang("1247" "LANG_EPON_SETTINGS"); %></title>
...
<div class="intro_main ">
	<p class="intro_title"><% multilang("1247" "LANG_EPON_SETTINGS"); %></p>
	<p class="intro_content"><% multilang("1248" "LANG_THIS_PAGE_IS_USED_TO_CONFIGURE_THE_PARAMETERS_FOR_EPON_NETWORK_ACCESS"); %></p>
</div>
...
<div class="btn_ctl clearfix">
	<input class="link_bg" type="submit" value="<% multilang("169" "LANG_APPLY_CHANGES"); %>" onclick="return applyclick(document.formeponconf)">&nbsp;&nbsp;
...
<div class="column" style="display:none">
	<div class="column_title">
		<div class="column_title_left"></div>
			<p><% multilang("1249" "LANG_LLID_MAC_MAPPING_TABLE"); %></p>
...
<div class="btn_ctl" style="display:none">
      <input class="link_bg" type="submit" value="<% multilang("169" "LANG_APPLY_CHANGES"); %>" onClick="return applyclick(document.formepon_llid_mac_mapping)">&nbsp;&nbsp;
      <input type="hidden" value="/epon.asp" name="submit-url">
      <input type="hidden" name="postSecurityFlag" value="">
</div>
</form>
