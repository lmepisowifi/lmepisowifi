...
<%SendWebHeadStr(); %>
<title><% multilang("862" "LANG_ACTIVE_DHCP_CLIENTS"); %></title>
...
<div class="intro_main ">
	<p class="intro_title"><% multilang("862" "LANG_ACTIVE_DHCP_CLIENTS"); %></p>
	<p class="intro_content"><% multilang("864" "LANG_THIS_TABLE_SHOWS_THE_ASSIGNED_IP_ADDRESS_MAC_ADDRESS_AND_TIME_EXPIRED_FOR_EACH_DHCP_LEASED_CLIENT"); %></p>
</div>
...
<div class="data_common data_vertical">
	<table>
		<tr>
			...
			<th width="30%"><% multilang("184" "LANG_EXPIRED_TIME_SEC"); %></th>
		</tr>
		<% dhcpClientList(); %>
	</table>
</div>
