...
<% SendWebHeadStr();%>
<title>TR-069 <% multilang("262" "LANG_CONFIGURATION"); %></title>
...
function saveChanges(obj)
{
  if (document.tr069.url.value=="") {
	alert("<% multilang("2487" "LANG_ACS_URL_CANNOT_BE_EMPTY"); %>");
	...
	if (sji_checkhttpurl(document.tr069.url.value) == false){
		alert("<% multilang("2488" "LANG_ACS_URL_INVALID"); %>");
		document.tr069.url.value = document.tr069.url.defaultValue;
		document.tr069.url.focus();
		return false;
	}
	...
	if (checkString(document.tr069.username.value) == 0) {
		alert("<% multilang("2118" "LANG_INVALID_USER_NAME"); %>");
  ...
  if (document.tr069.enable[1].checked) {
	if ( document.tr069.interval.value=="") {
		alert("<% multilang("2489" "LANG_PLEASE_INPUT_PERIODIC_INTERVAL_TIME_"); %>");
		document.tr069.interval.focus();
		return false;
	}
	if ( validateKey( document.tr069.interval.value ) == 0 ) {
		alert("<% multilang("2490" "LANG_INTERVAL_SHOULD_BE_THE_DECIMAL_NUMBER_0_9"); %>");
		document.tr069.interval.focus();
		return false;
	}
  }
	...
	if (checkString(document.tr069.conreqpath.value) == 0) {
		alert("<% multilang("2491" "LANG_INVALID_PATH"); %>");
		document.tr069.conreqpath.focus();
		return false;
	}
  if (document.tr069.conreqport.value=="") {
	alert("<% multilang("2492" "LANG_PLEASE_INPUT_THE_PORT_NUMBER_FOR_CONNECTION_REQUEST_"); %>");
  ...
  if ( validateKey( document.tr069.conreqport.value ) == 0 ) {
	alert("<% multilang("2493" "LANG_INVALID_PORT_NUMBER_OF_CONNECTION_REQUEST_IT_SHOULD_BE_1_65535"); %>");
	document.tr069.conreqport.value = document.tr069.conreqport.defaultValue;
	document.tr069.conreqport.focus();
	return false;
  }
...
<div class="intro_main ">
	<p class="intro_title">TR-069 <% multilang("262" "LANG_CONFIGURATION"); %></p>
	<p class="intro_content">  <% multilang("611" "LANG_THIS_PAGE_IS_USED_TO_CONFIGURE_THE_TR_069_CPE_HERE_YOU_MAY_CHANGE_THE_SETTING_FOR_THE_ACS_S_PARAMETERS"); %></p>
</div>
...
<div class="data_common data_common_notitle">
	<table>
		<tr>
			<th width="30%" style="font-weight: bold; font-size: 14"><% multilang("620" "LANG_TR069_DAEMON"); %>:</th>
			<td width="70%"><font size=2>
			<input type="radio" name=autoexec value=1 <% checkWrite("tr069-autoexec-1"); %> ><% multilang("200" "LANG_ENABLED"); %>&nbsp;&nbsp;
			<input type="radio" name=autoexec value=0 <% checkWrite("tr069-autoexec-0"); %> ><% multilang("201" "LANG_DISABLED"); %></font>
			</td>
		</tr>
		<tr>
			<th width="30%" style="font-weight: bold; font-size: 14"><% multilang("272" "LANG_ENABLE"); %>CWMP<% multilang("630" "LANG_PARAMETER"); %>:</th>
			<td width="70%"><font size=2>
			<input type="radio" name=enable_cwmp value=1 <% checkWrite("tr069-enable-cwmp-1"); %> ><% multilang("200" "LANG_ENABLED"); %>&nbsp;&nbsp;
			<input type="radio" name=enable_cwmp value=0 <% checkWrite("tr069-enable-cwmp-0"); %> ><% multilang("201" "LANG_DISABLED"); %></font>
			</td>
		</tr>
...
<table>
	...
	<tr>
			<th width="30%"><% multilang("622" "LANG_URL"); %>:</th>
		<td width="70%"><input type="text" name="url" size="32" maxlength="256" value=<% getInfo("acs-url"); %>></td>
	</tr>
	<tr>
		<th width="30%"><% multilang("860" "LANG_USER"); %><% multilang("724" "LANG_NAME"); %>:</th>
		<td width="70%"><input type="text" name="username" size="32" maxlength="256" value=<% getInfo("acs-username"); %>></td>
	</tr>
	<tr>
		<th width="30%"><% multilang("72" "LANG_PASSWORD"); %>:</th>
		<td width="70%"><input type="text" name="password" size="32" maxlength="256" value=<% getInfo("acs-password"); %>></td>
	</tr>
	<tr>
		<th width="30%"><% multilang("612" "LANG_PERIODIC_INFORM"); %>:</th>
		<td width="70%">
		<input type="radio" name=enable value=0 <% checkWrite("tr069-inform-0"); %> onClick="return periodicSel()"><% multilang("201" "LANG_DISABLED"); %>&nbsp;&nbsp;
		<input type="radio" name=enable value=1 <% checkWrite("tr069-inform-1"); %> onClick="return periodicSel()"><% multilang("200" "LANG_ENABLED"); %>
		</td>
	</tr>
	<tr>
		<th width="30%"><% multilang("613" "LANG_PERIODIC_INFORM_INTERVAL"); %>:</th>
...
<div class="column clearfix">
	<div class="column_title">
		<div class="column_title_left"></div>
		<p><% multilang("614" "LANG_CONNECTION_REQUEST"); %></p>
		<div class="column_title_right"></div>
	</div>
</div>
<div class="data_common">
...
<div class="column clearfix">
	<div class="column_title">
		<div class="column_title_left"></div>
		<p><% multilang("624" "LANG_TR069_STUN_SETTING"); %></p>
		<div class="column_title_right"></div>
	</div>
</div>
<div class="data_common">
<table>
  <tr>
	<td width="30%"><font size=2><b><% multilang("623" "LANG_TR069_STUN"); %>:</b></td>
	<td width="70%"><font size=2>
	<input type="radio" name=stun_enable value=0 <% checkWrite("stun-0"); %> onClick="return StunSel()"><% multilang("201" "LANG_DISABLED"); %>&nbsp;&nbsp;
	<input type="radio" name=stun_enable value=1 <% checkWrite("stun-1"); %> onClick="return StunSel()"><% multilang("200" "LANG_ENABLED"); %></font></td>
  </tr>
  <tr>
	<td width="30%"><font size=2><b><% multilang("623" "LANG_TR069_STUN"); %><% multilang("625" "LANG_TR069_STUN_SERVER"); %><% multilang("627" "LANG_TR069_STUN_SERVER_ADDRESS"); %>:</b></td>
	<td width="70%"><input type="text" name="stunsvraddr" size="32" maxlength="256" <% checkWrite("tr069-stun"); %> value=<% getInfo("stunsvr-addr"); %>></td>
  </tr>
  <tr>
        <td width="30%"><font size=2><b><% multilang("623" "LANG_TR069_STUN"); %><% multilang("625" "LANG_TR069_STUN_SERVER"); %><% multilang("626" "LANG_TR069_STUN_SERVER_PORT"); %>:</b></td>
        <td width="70%"><input type="text" name="stunsvrport" size="32" maxlength="5" <% checkWrite("tr069-stun"); %> value=<% getInfo("stunsvr-port"); %>></td>
  </tr>
  <tr>
	<td width="30%"><font size=2><b><% multilang("623" "LANG_TR069_STUN"); %><% multilang("625" "LANG_TR069_STUN_SERVER"); %><% multilang("628" "LANG_TR069_STUN_SERVER_USERNAME"); %>:</b></td>
	<td width="70%"><input type="text" name="stunsvruname" size="32" maxlength="256" <% checkWrite("tr069-stun"); %> value=<% getInfo("stunsvr-uname"); %>></td>
  </tr>
  <tr>
        <td width="30%"><font size=2><b><% multilang("623" "LANG_TR069_STUN"); %><% multilang("625" "LANG_TR069_STUN_SERVER"); %><% multilang("629" "LANG_TR069_STUN_SERVER_USERPASSWD"); %>:</b></td>
...
<div class="btn_ctl">
	...
	<input class="link_bg" type="reset" value=<% multilang("363" "LANG_UNDO"); %> name="reset" onClick="resetClick()">
...
<table>
	<tr>
		<th width="30%"><% multilang("272" "LANG_ENABLE"); %> CWMP WAN ACL:</th>
		<td width="70%">
		<input type="radio" name=enable_acl value=1 <% checkWrite("tr069-enable-acl-1"); %> ><% multilang("200" "LANG_ENABLED"); %>&nbsp;&nbsp;
		<input type="radio" name=enable_acl value=0 <% checkWrite("tr069-enable-acl-0"); %> ><% multilang("201" "LANG_DISABLED"); %>&nbsp;&nbsp;&nbsp;&nbsp;
		
		<input class="inner_btn" type="submit" value="<% multilang("169" "LANG_APPLY_CHANGES"); %>" name="applyACL" onClick="return on_submit(this)">&nbsp;&nbsp; </td>
	</tr>
	<tr>
	...
	<tr>
		<th width="30%"><% multilang("95" "LANG_SUBNET_MASK"); %>:</th>
		<td width="70%"><input type="text" name="aclMask" size="15" maxlength="15"></td>      
	</tr>
</table>
</div>
<div class="btn_ctl">
	<td><input class="link_bg" type="submit" value="<% multilang("245" "LANG_ADD"); %>" name="addIP" onClick="return addClick(this)">&nbsp;&nbsp;</td>
</div>
<div class="column clearfix">
	<div class="column_title">
		<div class="column_title_left"></div>
		<p>CWMP WAN ACL <% multilang("357" "LANG_TABLE"); %></p>
		<div class="column_title_right"></div>
	</div>
</div>
...
<div class="btn_ctl">
      <input class="link_bg" type="submit" value="<% multilang("248" "LANG_DELETE_SELECTED"); %>" name="delIP" onClick="return deleteClick(this)">&nbsp;&nbsp;      
      <input type="hidden" value="/tr069config.asp" name="submit-url">
      <input type="hidden" name="postSecurityFlag" value="">
</div>
</form>
