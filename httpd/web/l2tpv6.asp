...
<%SendWebHeadStr(); %>
<title>L2TP VPN <% multilang("262" "LANG_CONFIGURATION"); %></title>
...
function checkLacOverIPSec(){
	if(L2TPOverIPSec){
		if(document.l2tp.overipsecLAC.checked){
			...
			{
				alert("<% multilang("2319" "LANG_INVALID_VALUE_IN_PASSWORD"); %>");
				document.l2tp.IKEPreshareKeyLAC.focus();
				return false;
			}
...
function setL2tpServer(obj)
{
	...
	if (document.l2tp.s_name.value=="") {
		alert('<% multilang("2327" "LANG_PLEASE_ENTER_L2TP_SERVER_RULE_NAME"); %>');
		document.l2tp.s_name.focus();
		return false;
	}

	if (document.l2tp.peeraddr.value=="") {
		alert('<% multilang("2325" "LANG_PLEASE_ENTER_PEER_START_ADDRESS"); %>');
	...
	if (document.l2tp.localaddr.value=="") {
		alert('<% multilang("2326" "LANG_PLEASE_ENTER_LOCAL_ADDRESS"); %>');
...
function addL2tpAccount(obj)
{
	...
	if(document.l2tp.s_tunnelAuth.checked){
		if(document.l2tp.s_authKey.value ==""){
			alert('<% multilang("2328" "LANG_PLEASE_ENTER_L2TP_TUNNEL_AUTHKEY"); %>');
	...
	{
		alert('<% multilang("2329" "LANG_PLEASE_ENTER_L2TP_SERVER_USERNAME"); %>');
	...
	if (document.l2tp.s_password.value=="") {
		alert('<% multilang("2330" "LANG_PLEASE_ENTER_L2TP_SERVER_PASSWORD"); %>');
...
function addL2TPItf(obj)
{
	...
	if (document.l2tp.c_name.value=="") {
		alert('<% multilang("2331" "LANG_PLEASE_ENTER_L2TP_CLIENT_RULE_NAME"); %>');
		document.l2tp.c_name.focus();
		return false;
	}

	if (document.l2tp.server.value=="") {		
		alert('<% multilang("2312" "LANG_PLEASE_ENTER_L2TP_SERVER_ADDRESS"); %>');
	...
	if (document.l2tp.IpProtocolType.value == 2)
	{
		...
		{			
			alert('<% multilang("2333" "LANG_PLEASE_INPUT_IPV6_ADDRESS"); %>');
			document.l2tp.server.focus();
			return false;
		}
	}
	else if (document.l2tp.IpProtocolType.value == 1)
	{
		...
		{			
			alert('<% multilang("2334" "LANG_PLEASE_INPUT_IPV4_ADDRESS"); %>');
			document.l2tp.server.focus();
			return false;
		}
	}
	...
	if (document.l2tp.tunnel_auth.checked)
	{
		...
		{			
			alert('<% multilang("2314" "LANG_PLEASE_ENTER_L2TP_TUNNEL_AUTHENTICATION_SECRET"); %>');
			document.l2tp.tunnel_secret.focus();
			return false;
		}
		if(!checkTextStr(document.l2tp.tunnel_secret.value))
		{			
			alert('<% multilang("2315" "LANG_INVALID_VALUE_IN_TUNNEL_AUTHENTICATION_SECRET"); %>');
			document.l2tp.tunnel_secret.focus();
			return false;		
		}
	}
	...
	if (document.l2tp.auth.selectedIndex!=3)
	{
		...
		{			
			alert('<% multilang("2316" "LANG_PLEASE_ENTER_L2TP_CLIENT_USERNAME"); %>');
			document.l2tp.username.focus();
			return false;
		}
		if(!checkTextStr(document.l2tp.username.value))
		{			
			alert('<% multilang("2317" "LANG_INVALID_VALUE_IN_USERNAME"); %>');
			document.l2tp.username.focus();
			return false;		
		}
		if (document.l2tp.password.value=="") {			
			alert('<% multilang("2318" "LANG_PLEASE_ENTER_L2TP_CLIENT_PASSWORD"); %>');
	...
	if (document.l2tp.pppconntype.selectedIndex==1)
	{
		...
		{			
			alert('<% multilang("2320" "LANG_PLEASE_ENTER_L2TP_TUNNEL_IDLE_TIME"); %>');
	...
	{		
		alert('<% multilang("2322" "LANG_PLEASE_ENTER_L2TP_TUNNEL_MTU"); %>');
...
<div class="intro_main ">
	<p class="intro_title">L2TP VPN <% multilang("262" "LANG_CONFIGURATION"); %></p>
	<p class="intro_content"> <% multilang("735" "LANG_THIS_PAGE_IS_USED_TO_CONFIGURE_THE_PARAMETERS_FOR_L2TP_MODE_VPN"); %></p>
</div>
...
<div class="data_common data_common_notitle">
	<table>
		<tr>
			<th>L2TP VPN:</th>
			<td>
				<input type="radio" value="0" name="l2tpen" <% checkWrite("l2tpenable0"); %> onClick="onClickL2TPEnable()"><% multilang("271" "LANG_DISABLE"); %>&nbsp;&nbsp;
				<input type="radio" value="1" name="l2tpen" <% checkWrite("l2tpenable1"); %> onClick="onClickL2TPEnable()"><% multilang("272" "LANG_ENABLE"); %>
			</td>
		</tr>
	</table>
</div>
...
<div class="data_common data_common_notitle">
	<table>
		...
		<tr>
			<th>PPP <% multilang("224" "LANG_ENCRYPTION"); %>:</th>
			<td><select name="enctype" >
					<option value="0"><% multilang("373" "LANG_NONE"); %></option>
		...
		<tr>
			<th><% multilang("860" "LANG_USER"); %><% multilang("724" "LANG_NAME"); %>:</th>
			<td><input type="text" name="username" size="15" maxlength="35"></td>
		</tr>
		<tr>
			<th><% multilang("72" "LANG_PASSWORD"); %>:</th>
			<td><input type="password" name="password" size="15" maxlength="35">
			    <input type="checkbox" onClick="show_password(1)">Show Password</td>
		</tr>
		<tr>
			<th>PPP <% multilang("309" "LANG_CONNECTION_TYPE"); %>:</th>
			<td><select name="pppconntype" onChange="connTypeChange()">
					<option value="0"><% multilang("738" "LANG_PERSISTENT"); %></option>
					<option value="1"><% multilang("739" "LANG_DIAL_ON_DEMAND"); %></option>
					<option value="2"><% multilang("493" "LANG_MANUAL"); %></option>
					<option value="3"><% multilang("373" "LANG_NONE"); %></option>
				</select>
			</td>
		</tr>
		<tr>
			<th><% multilang("370" "LANG_IDLE_TIME_MIN"); %>:</th>
		...
		<tr>
			<th><% multilang("90" "LANG_DEFAULT_GATEWAY"); %>:</th>
...
<div class="btn_ctl">
      <input class="link_bg" type="submit" value="<% multilang("169" "LANG_APPLY_CHANGES"); %>" name="addClient" onClick="return addL2TPItf(this)">&nbsp;&nbsp;
</div>

<div class="column">
	<div class="column_title">
		<div class="column_title_left"></div>
			<p>L2TP <% multilang("357" "LANG_TABLE"); %></p>
		<div class="column_title_right"></div>
	</div>
	<div class="data_common">
		<table>
			<tr>
				<th align=center width="3%"><% multilang("250" "LANG_SELECT"); %></th>
				<th align=center width="5%"><% multilang("724" "LANG_NAME"); %></th>
				<th align=center width="5%"><% multilang("96" "LANG_SERVER"); %></th>
				<th align=center width="5%"><% multilang("736" "LANG_TUNNEL_AUTHENTICATION"); %></th>
				<th align=center width="5%">PPP <% multilang("225" "LANG_AUTHENTICATION"); %></th>
				<th align=center width="5%">MTU</th>
				<th align=center width="5%"><% multilang("90" "LANG_DEFAULT_GATEWAY"); %></th>
				<% l2tpWithIPSecLACTable(); %>
				<th align=center width="8%"><% multilang("734" "LANG_ACTION"); %></th>
			</tr>
			<% l2tpList(); %>
		</table>
	</div>
...
<div class="btn_ctl">
	<input class="link_bg" type="submit" value="<% multilang("248" "LANG_DELETE_SELECTED"); %>" name="delSelClient" onClick="return deleteClick(this)">&nbsp;&nbsp;
...
<div class="column">
	...
	<div class="data_common">
		<table>
			...
			<tr>
				<th><% multilang("322" "LANG_AUTHENTICATION_METHOD"); %>:</th>
				<td>
...
<div class="btn_ctl">
	<input class="link_bg" type="submit" value="<% multilang("169" "LANG_APPLY_CHANGES"); %>" name="addServer" onClick="return setL2tpServer(this)">
</div>
	...
	<div class="data_common">
		<table>
			...
			<tr>
				<th>Tunnel:</th>
				<td>
					<input type="radio" value="0" name="tunnelen"><% multilang("271" "LANG_DISABLE"); %>&nbsp;&nbsp;
					<input type="radio" value="1" name="tunnelen" checked><% multilang("272" "LANG_ENABLE"); %>
				</td>
			</tr>
			<tr>
				<th><% multilang("1195" "LANG_USERNAME"); %>:</th>
...
<div class="btn_ctl">
	<input class="link_bg" type="submit" value="<% multilang("245" "LANG_ADD"); %>" name="addAccount" onClick="return addL2tpAccount(this)">
</div>
...
<div class="column">
	...
	<div class="data_common">
		<table>
			<tr>
				<th align=center><% multilang("250" "LANG_SELECT"); %></th>
				<th align=center><% multilang("724" "LANG_NAME"); %></th>
				<th align=center><% multilang("272" "LANG_ENABLE"); %></th>
				<th align=center><% multilang("1195" "LANG_USERNAME"); %></th>
				<th align=center><% multilang("72" "LANG_PASSWORD"); %></th>
			</tr>
			<% l2tpServerList(); %>
		</table>
	</div>
...
<div class="btn_ctl">
	<input class="link_bg" type="submit" value="<% multilang("169" "LANG_APPLY_CHANGES"); %>" name="saveAccount" onClick="return on_submit(this)">&nbsp;&nbsp;
	<input class="link_bg" type="submit" value="<% multilang("248" "LANG_DELETE_SELECTED"); %>" name="delSelAccount" onClick="return deleteClick(this)">&nbsp;&nbsp;
