...
<%SendWebHeadStr(); %>
<TITLE>QoS <% multilang("42" "LANG_CLASSIFICATION"); %></TITLE>
...
<div class="intro_main ">
	<p class="intro_title">QoS <% multilang("42" "LANG_CLASSIFICATION"); %></p>
	<p class="intro_content"> <% multilang("718" "LANG_PAGE_DESC_CLASSICY_QOS_RULE"); %><font color="red">(<% multilang("719" "LANG_PAGE_DESC_CLASSICY_QOS_RULE_EXTRA"); %>)</font></p>
...
<div class="data_common data_common_notitle">
	<div class="data_common data_vertical">
		<table id="lstrc" >
			<tr>
				<th colspan="2">&nbsp;</th>
				<th colspan="3" align="center"><% multilang("721" "LANG_MARK"); %></th>
				<th colspan="3"><% multilang("720" "LANG_CLASSIFICATION_RULES"); %></th>
				<th colspan="3" align="center">&nbsp;</th>
			</tr>
			<tr>
				<td><% multilang("722" "LANG_ID"); %></td>
				<td><% multilang("724" "LANG_NAME"); %></td>
				<td>Order</td>
				<!--<td><% multilang("141" "LANG_VLAN_ID"); %></td>-->
				<td>DSCP <% multilang("721" "LANG_MARK"); %></td>
				<td><% multilang("728" "LANG_802_1P"); %></td>         
				<td> <% multilang("713" "LANG_QUEUE"); %></td>
				<td> <% multilang("729" "LANG_WANIF"); %></td>
				<td><% multilang("730" "LANG_RULE_DETAIL"); %></td>					
				<td><% multilang("335" "LANG_DELETE"); %></td>
				<td><% multilang("726" "LANG_EDIT"); %></td>	
				<td>&nbsp;</td>
			</tr>
		</table>
	</div>
...
<div class=btn_ctl>
	<input class=link_bg type="button" class="button" onClick="location.href='net_qos_cls_edit.asp';" value="<% multilang("245" "LANG_ADD"); %>">
