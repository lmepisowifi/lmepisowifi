		...
		if(type&1)
		{
			if(sIfId6Start.value != "")
			{
				if (!sIfId6Start.value.match(ifid_regex) ){
					alert('<% multilang("2270" "LANG_INVALID_SOURCE_IPV6_INTERFACE_ID_START_ADDRESS"); %>');
...
function addClick(obj)
{
	...
	if(Src_Dst_All_Empty == 1)
	{
		...
		{
			alert('<% multilang("2269" "LANG_INPUT_FILTER_RULE_IS_NOT_VALID"); %>');
			return false;
		}
		else//TCP/UDP 
		{
...
<div class="data_common data_common_notitle">
	<table>	
		<tr>
			<th width="30%"><% multilang("424" "LANG_DEFAULT_ACTION"); %>:&nbsp;&nbsp;</th>
			<td><input type="radio" name="outAct" value=0 <% checkWrite("v6_ipf_out_act0"); %>><% multilang("411" "LANG_DENY"); %>&nbsp;&nbsp;
	   			<input type="radio" name="outAct" value=1 <% checkWrite("v6_ipf_out_act1"); %>><% multilang("412" "LANG_ALLOW"); %>&nbsp;&nbsp;</td>
			<td><input class="inner_btn" type="submit" value="<% multilang("169" "LANG_APPLY_CHANGES"); %>" name="setDefaultAction" onClick="return on_submit(this)">&nbsp;&nbsp;
...
<div class="data_common data_common_notitle">
	<table>
		...
		<tr>
			<th width="30%">
				<% multilang("417" "LANG_RULE_ACTION"); %>:
			</th>
			<td width="70%">
...
<table>
   <tr>
		<th width="30%"><% multilang("418" "LANG_SOURCE"); %> :</th>
		<td>
			<select name="saType" onChange="saTypeSelect()">
			<option select value=1><% multilang("94" "LANG_IP_ADDRESS"); %>+<% multilang("495" "LANG_PREFIX_LENGTH"); %></option>
			<option value=2>PD+<% multilang("514" "LANG_INTERFACE_ID"); %></option>
			</select>
		</td>
   </tr>
   <tr id="sifid">
	  <th><% multilang("418" "LANG_SOURCE"); %> <% multilang("514" "LANG_INTERFACE_ID"); %>:</th> 
	  <td><input type="text" size="16" name="sIfId6Start" style="width:150px"> </td>
   </tr>
   <tr id="sip6">
	  <th><% multilang("418" "LANG_SOURCE"); %> <% multilang("94" "LANG_IP_ADDRESS"); %>:</th>
   ...
   <tr>
		<th><% multilang("419" "LANG_DESTINATION"); %> :</th>
		<td>
   ...
   <tr id="difid">
	  <th><% multilang("419" "LANG_DESTINATION"); %> <% multilang("514" "LANG_INTERFACE_ID"); %>:</th>
