...
<% SendWebHeadStr();%>
<title>Tracert6 <% multilang("46" "LANG_DIAGNOSTICS"); %></title>
<script>
...
<div class="intro_main ">
	<p class="intro_title">Traceroute6 <% multilang("46" "LANG_DIAGNOSTICS"); %></p>
	<p class="intro_content"><% multilang("523" "LANG_PAGE_DESC_TRACERT6_DIAGNOSTIC"); %></p>
</div>
