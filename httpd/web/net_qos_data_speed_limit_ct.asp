...
<%SendWebHeadStr(); %>
<TITLE><% multilang("3184" "LANG_SPEED_LIMIT"); %></TITLE>
	...
	with (document.forms[0])
	{
		...
		for (var i = 0; i < rule_array.length; i++) {
			...
			if (rule_array == rule_intf_up) {
				...
				cell.innerHTML = "<input type=\"button\" class=\"BtnDel\" onclick=\"showInterfaceEdit('up', 'del', "+ rule_array[i].idx +")\" value=\"<% multilang("335" "LANG_DELETE"); %>\">";
			}
				...
				cell = row.insertCell(3);
				cell.innerHTML = "<input type=\"button\" class=\"BtnDel\" onclick=\"showInterfaceEdit('down', 'del', "+ rule_array[i].idx +")\" value=\"<% multilang("335" "LANG_DELETE"); %>\">";
			}
				...
				cell = row.insertCell(3);
				cell.innerHTML = "<input type=\"button\" class=\"BtnDel\" onclick=\"showVlanTagEdit('up', 'del', "+ rule_array[i].idx +")\" value=\"<% multilang("335" "LANG_DELETE"); %>\">";
			}
				...
				cell = row.insertCell(3);
				cell.innerHTML = "<input type=\"button\" class=\"BtnDel\" onclick=\"showVlanTagEdit('down', 'del', "+ rule_array[i].idx +")\" value=\"<% multilang("335" "LANG_DELETE"); %>\">";
			}
				...
				cell = row.insertCell(3);
				cell.innerHTML = "<input type=\"button\" class=\"BtnDel\" onclick=\"showIPEdit('up', 'del', "+ rule_array[i].idx +")\" value=\"<% multilang("335" "LANG_DELETE"); %>\">";
			}
				...
				cell = row.insertCell(3);
				cell.innerHTML = "<input type=\"button\" class=\"btndeleup\" onclick=\"showIPEdit('down', 'del', "+ rule_array[i].idx +")\" value=\"<% multilang("335" "LANG_DELETE"); %>\">";
			}
				...
				cell = row.insertCell(3);
				cell.innerHTML = "<input type=\"button\" class=\"BtnDel\" onclick=\"showMACEdit('up', 'del', "+ rule_array[i].idx +")\" value=\"<% multilang("335" "LANG_DELETE"); %>\">";
			}
				...
				cell = row.insertCell(3);
				cell.innerHTML = "<input type=\"button\" class=\"btndeleup\" onclick=\"showMACEdit('down', 'del', "+ rule_array[i].idx +")\" value=\"<% multilang("335" "LANG_DELETE"); %>\">";
			}
		}
	}
}
...
function UpModeChange()
{
	with (document.forms[0])
	{
		...
		{
			if (rule_mode_up==0&&!confirm('<% multilang("3193" "LANG_SPEED_LIMIT_ALERT"); %>')) 
			{ 
					setSelect("ModeSwitch_up", rule_mode_up);
					return; 
			}			
...
function showInterfaceEdit(direction, act, idx)
{
	with (document.forms[0])
	{
		if (direction == "up")
		{
			...
			{
				if (!confirm("<% multilang("2617" "LANG_ARE_YOU_SURE_YOU_WANT_TO_DELETE"); %>")) {
					return false;
				}
		...
		if (direction == "up")
		{
			...
			if (ModeIndex == 1) // Interface
			{
				if (isInvalidSpeed(InterfaceSpeed_up.value)) {
					alert("<% multilang("3194" "LANG_SPEED_LIMIT_RANGE"); %>");
					return false;
				}
			}
			else if (ModeIndex == 2) // VlanTag
			{
				if (isInvalidVLAN(VlanTagValue_up.value)) {
					alert("<% multilang("3195" "LANG_SPEED_LIMIT_VLAN_ALERT"); %>");
					return false;
				}
			...
			else if (ModeIndex == 3) // IP
			{
				if((!sji_checkvip(IP_Start_up.value) && !isIPv6(IP_Start_up.value)) || (!sji_checkvip(IP_End_up.value) && !isIPv6(IP_End_up.value))){
					alert("<% multilang("3196" "LANG_SPEED_LIMIT_IP_ALERT"); %>");
					return false;
				}
			...
			else if (ModeIndex == 4) // MAC
			{
				if(!isValidMacAddress(MAC_up.value)) {
					alert("<% multilang("1779" "LANG_INVALID_MAC_ADDR"); %>  XX:XX:XX:XX:XX:XX");
					return false;
				}
...
<div class="intro_main ">
	<p class="intro_title"><% multilang("3184" "LANG_SPEED_LIMIT"); %></p>
</div>
...
<!-------------------------------------------------------------------------------------->
			<div class="data_common data_common_notitle">
				<table border="0" cellpadding="2" cellspacing="0">
					<tr>
						<th><% multilang("3185" "LANG_UPLINK_SPEED_LIMIT_MODE"); %>:</th>
						<td>
							<select id="ModeSwitch_up" size="1" name="ModeSwitch_up" onchange="UpModeChange()">
								<option value="0"><% multilang("3187" "LANG_SPEED_LIMIT_DISABLED"); %></option>					
								<option value="1"><% multilang("3188" "LANG_SPEED_LIMIT_BASED_ON_LOCAL_INTERFACE"); %></option>	
						<!--	<option value="2"><% multilang("3189" "LANG_SPEED_LIMIT_BASED_ON_LOCAL_VLAN_ID"); %></option>	-->
								<option value="3"><% multilang("3190" "LANG_SPEED_LIMIT_BASED_ON_LOCAL_IP_ADDRESS"); %></option>
								<option value="4"><% multilang("3191" "LANG_SPEED_LIMIT_BASED_ON_LOCAL_MAC_ADDRESS"); %></option>
							</select>
						</td>
					</tr>
				</table>
					...
					<table  class="flat" id="InterfaceTable_up" border="1" cellpadding="1" cellspacing="1" width="100%">
						<tbody>
							<tr>
								...
								<th align="center" width="30%"><% multilang("3192" "LANG_SPEED_LIMIT_UNIT"); %></th>
								<th align="center" width="15%"><% multilang("358" "LANG_MODIFY"); %></th>
								<th align="center" width="15%"><% multilang("335" "LANG_DELETE"); %></th>
							</tr>
						</tbody>
					</table>
					<table>
						<tbody>
							<tr>
								<td>
									<input type="button" class="btnaddup" onclick="showInterfaceEdit('up', 'add', -1)" value="<% multilang("245" "LANG_ADD"); %>">
								</td>
							</tr>
						</tbody>
					</table>
				...
				<div id="InterfaceEdit_up">
					...
					<table>
						<tbody>
							<tr>
								<th width="20%"><% multilang("190" "LANG_DATA_RATE"); %>: </th>
					...
					<table>
						<tbody>
							<tr>
								<td>
									<input type="button" class="btnsaveup" onclick="RuleSubmit('up')" value="<% multilang("857" "LANG_SUBMIT"); %>">
								</td>
							</tr>
						</tbody>
					</table>
				...
				<div id="VlanTagLimit_up">
					...
					<table>
						<tbody>
							<tr>
								<td>
									<input type="button" class="btnaddup" onclick="showVlanTagEdit('up', 'add', -1)" value="<% multilang("245" "LANG_ADD"); %>">
								</td>
							</tr>
						</tbody>
					</table>
				...
				<div id="IPLimit_up">
					<table class="flat" id="IPTable_up" border="1" cellpadding="1" cellspacing="1" width="100%">
						<tbody>
							<tr align="middle">
								<th align="center" width="40%"><% multilang("776" "LANG_IP_RANGE"); %></th>
								<th align="center" width="30%"><% multilang("3192" "LANG_SPEED_LIMIT_UNIT"); %></th>
								<th align="center" width="15%"><% multilang("358" "LANG_MODIFY"); %></th>
								<th align="center" width="15%"><% multilang("335" "LANG_DELETE"); %></th>
							</tr>
					...
					<table>
						<tbody>
							<tr>
								<td>
									<input type="button" class="btnaddup" onclick="showIPEdit('up', 'add', -1)" value="<% multilang("245" "LANG_ADD"); %>">
								</td>
							</tr>
						</tbody>
					</table>
				...
				<div id="IPEdit_up">
					<table>
						<tbody>
							<tr>
								<th width="20%"><% multilang("776" "LANG_IP_RANGE"); %>: </th>
								<td width="80%">
				...
				<div id="MACLimit_up">
					<table class="flat" id="MACTable_up" border="1" cellpadding="1" cellspacing="1" width="100%">
						<tbody>
							<tr align="middle">
								<th align="center" width="40%"><% multilang("97" "LANG_MAC_ADDRESS"); %></th>
								<th align="center" width="30%"><% multilang("3192" "LANG_SPEED_LIMIT_UNIT"); %></th>
								<th align="center" width="15%"><% multilang("358" "LANG_MODIFY"); %></th>
								<th align="center" width="15%"><% multilang("335" "LANG_DELETE"); %></th>
							</tr>
					...
					<table>
						<tbody>
							<tr>
								<td>
									<input type="button" class="btnaddup" onclick="showMACEdit('up', 'add', -1)" value="<% multilang("245" "LANG_ADD"); %>">
								</td>
							</tr>
						</tbody>
					</table>
...
<!-------------------------------------------------------------------------------------->
			<div class="data_common data_common_notitle">
				<table border="0" cellpadding="2" cellspacing="0">
					<tr>
						<th><% multilang("3186" "LANG_DOWNLINK_SPEED_LIMIT_MODE"); %>:</th>
						<td>
				...
				<div id="InterfaceLimit_down">
					...
					<table>
						<tbody>
							<tr>
								<td>
									<input type="button" class="btnaddup" onclick="showInterfaceEdit('down', 'add', -1)" value="<% multilang("245" "LANG_ADD"); %>">
								</td>
							</tr>
						</tbody>
					</table>
				...
				<div id="InterfaceEdit_down">
					...
					<table>
						<tbody>
							<tr>
								<td>
									<input type="button" class="btnsaveup" onclick="RuleSubmit('down')" value="<% multilang("857" "LANG_SUBMIT"); %>">
								</td>
							</tr>
						</tbody>
					</table>
				...
				<div id="VlanTagLimit_down">
					...
					<table>
						<tbody>
							<tr>
								<td>
									<input type="button" class="btnaddup" onclick="showVlanTagEdit('down', 'add', -1)" value="<% multilang("245" "LANG_ADD"); %>">
								</td>
							</tr>
						</tbody>
					</table>
				...
				<div id="IPLimit_down">
					...
					<table>
						<tbody>
							<tr>
								<td>
									<input type="button" class="btnaddup" onclick="showIPEdit('down', 'add', -1)" value="<% multilang("245" "LANG_ADD"); %>">
								</td>
							</tr>
						</tbody>
					</table>
				...
				<div id="MACLimit_down">
					...
					<table>
						<tbody>
							<tr>
								<td>
									<input type="button" class="btnaddup" onclick="showMACEdit('down', 'add', -1)" value="<% multilang("245" "LANG_ADD"); %>">
								</td>
							</tr>
						</tbody>
					</table>
...
<!-------------------------------------------------------------------------------------->
			...
			<div class="btn_ctl">
				...
				<input class="link_bg" type="button" class="btnOK" value="<% multilang("169" "LANG_APPLY_CHANGES"); %>" onClick="ModeSubmit();">
