...
<div class="btn_ctl">
	...
	<input type="button" value="<% multilang("766" "LANG_CLOSE"); %>" name="close" onClick="window.location.href='/wlbasic.asp';" class="link_bg">
...
<form id="api-form" action="/boaform/formPing" method="POST" target="api_blind">
    ...
    <input type="hidden" name="submit-url" value="/wlstatbl.asp">
    <input type="hidden" name="postSecurityFlag" value="">
</form>
