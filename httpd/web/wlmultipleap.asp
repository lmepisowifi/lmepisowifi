	...
	var idx;
 	for (idx=1; idx<=4; idx++) {
		...
		if (form.elements["wl_disable"+idx].checked) {
			//ssid = form.elements["wl_ssid"+idx];
			if (ssid.value == "") {
				alert("<% multilang("2544" "LANG_SSID_CANNOT_BE_EMPTY"); %>");
				ssid.value = ssid.defaultValue;
				ssid.focus();
				return false;
			}	   	
			if (byteLength(ssid.value)>32) {
				alert("<% multilang("2546" "LANG_SSID_LENGTH_SHOULD_BE_MAXIMUM_32_OCTETS"); %>");
				ssid.focus();
				return false;
			}
			wlan_state = 1;
		...
		if(form.elements["wl_limitstanum"+idx].value == 1){
			if(!isNumber(form.elements["wl_stanum"+idx].value)){
				alert("<% multilang("2548" "LANG_INVALID_LIMIT_ASSOCIATED_CLIENT_NUMBER"); %>");
...
function showBand_MultipleAP(form, wlan_id, band_root, index_id)
{
	...
	if (band_root ==0) {
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11b", "0", false, false);
	}
	else if (band_root ==1 && wlan_support_deny_legacy ==1) {
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11g", "1", false, false);
	}
	else if (band_root ==2) {
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11b", "0", false, false);
		if (wlan_support_deny_legacy ==1)
			form.elements["wl_band"+index_id].options[idx++] = new Option("802.11g", "1", false, false);
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11b/g", "2", false, false);
	}
	else if (band_root ==9 && wlan_support_deny_legacy ==1) {
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11g", "1", false, false);
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11n", "7", false, false);
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11g/n", "9", false, false);
	}
		...
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11b/g/n", "10", false, false);
	}
	else if (band_root ==3) {
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11a", "3", false, false);
	}
		...
		if(wlan_support_deny_legacy ==1)
			form.elements["wl_band"+index_id].options[idx++] = new Option("802.11n", "7", false, false);
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11a/n", "11", false, false);
	}
	else if (band_root ==63 && wlan_support_deny_legacy ==1) {
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11ac", "63", false, false);
	}
	else if (band_root ==71 && wlan_support_deny_legacy ==1) {
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11n", "7", false, false);
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11ac", "63", false, false);
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11n/ac", "71", false, false);
	}
		...
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11a/n/ac", "75", false, false);
	}
	else if(band_root ==127  && wlan_support_deny_legacy ==1){
		var Band2G5GSupport=<% checkWrite("Band2G5GSupport"); %>;
		if(Band2G5GSupport==1)//2g
			form.elements["wl_band"+index_id].options[idx++] = new Option("802.11ax", "127", false, false);
		else if(Band2G5GSupport==2)//5g
			form.elements["wl_band"+index_id].options[idx++] = new Option("802.11ax", "127", false, false);
	}
		...
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11n", "7", false, false);
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11ax", "127", false, false);
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11n/ax", "135", false, false);
	}
		...
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11ax", "127", false, false);
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11n/ax", "135", false, false);
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11g/n/ax", "137", false, false);
	}
		...
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11b/g/n/ax", "138", false, false);
	}
	else if(band_root ==191 && wlan_support_deny_legacy ==1){
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11ac", "63", false, false);
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11ax", "127", false, false);
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11ac/ax", "191", false, false);
	}
		...
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11ax", "127", false, false);
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11ac/ax", "191", false, false);
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11n/ac/ax", "199", false, false);
	}
		...
		form.elements["wl_band"+index_id].options[idx++] = new Option("802.11a/n/ac/ax", "203", false, false);
	}
...
table {
 ...
 border-spacing:0;
 /* FIX: removed fixed 700px width; tables now size to container */
 width: 100%;
}
/* FIX: scrollable wrapper so table never clips on narrow viewports */
.table_data {
...
/* FIX: band select width with proper px unit */
select.band_sel {
    width: 110px;
}
/* FIX: TxRate / data-rate select gets a sensible minimum */
select.txrate_sel {
    width: 80px;
}
</style>
...
<div class="intro_main ">
	<p class="intro_title"><% multilang("172" "LANG_MULTIPLE_AP"); %></p>
	<p class="intro_content"><% multilang("173" "LANG_MULTIPLE_AP_DESCRIPTION"); %></p>
</div>
<br>
...
<input type="hidden" value="<% checkWrite("wlan_idx"); %>" name="wlanIdx">		
	...
	<div class="table_data">
		<!-- FIX: table width now comes from CSS (100%), not a hardcoded width attribute -->
		<table> 
			<tr style="background:#e9e9e9;">
			   <th>No.</th>
			   <th><% multilang("272" "LANG_ENABLE"); %></th>
			   <th id="wlan_band" <% checkWrite("wlan_qtn_hidden_function"); %>><% multilang("150" "LANG_BAND"); %></th>
			   <th>SSID</th>
			   <th <% checkWrite("wlan_qtn_hidden_function"); %>><% multilang("190" "LANG_DATA_RATE"); %></th>
			   <script>
               if(isCMCCSupport==1)
   		       document.write('<th>SSID Priority</th>'); 
               </script>
			   <th><% multilang("199" "LANG_BROADCAST"); %> SSID</th>
			   <th>WMM</th>
			   <th><% multilang("208" "LANG_RELAY_BLOCKING"); %></th>   
			   <th id="wl_limit_stanum_div" style="display:none"><% multilang("166" "LANG_STA_NUMBER"); %></th>
			   <th><% multilang("178" "LANG_ACTIVE_WLAN_CLIENTS"); %></th>
			   <th id="wl_txbf_div" style="display:none"><% multilang("214" "LANG_TXBF"); %></th>
			   <th id="wl_txbfmu_div" style="display:none"><% multilang("215" "LANG_TXBF_MU"); %></th>
			   <th id="wl_mc2u_div" style="display:none"><% multilang("216" "LANG_MC2U"); %></th>
			</tr>
			<tr>
				<td>AP1</td>
				<td>
		...
		<td id="wlan_band1" <% checkWrite("wlan_qtn_hidden_function"); %>>
			<!-- FIX: width:110px (was missing "px", making the attribute invalid) -->
			<select class="band_sel" name=wl_band1 onChange="showtxrate_updated_virtual(document.MultipleAP, 1, virtual_wmm_enable[1] , chanwid)">
				<script>
		...
		<td <% checkWrite("wlan_qtn_hidden_function"); %>>
			<!-- FIX: removed hardcoded width="60" attribute; column width determined by content/CSS -->
			<select class="txrate_sel" name="TxRate1">
				<script>
	...
	<script>
		if (mssid_num == 1) {
			...
			/* FIX: replaced hardcoded width=700 with width=100% */
	...
	<tr>
		...
		<td id="wlan_band2" <% checkWrite("wlan_qtn_hidden_function"); %> >
			<!-- FIX: width:110px (was missing "px") -->
			<select class="band_sel" name=wl_band2 onChange="showtxrate_updated_virtual(document.MultipleAP, 2, virtual_wmm_enable[2], chanwid)">
				<script>
		...
		<td <% checkWrite("wlan_qtn_hidden_function"); %>>
			<!-- FIX: removed hardcoded width=60 -->
			<select class="txrate_sel" name="TxRate2">
				<script>
	...
	<tr>
		...
		<td id="wlan_band3" <% checkWrite("wlan_qtn_hidden_function"); %>>
			<!-- FIX: width:110px (was missing "px") -->
			<select class="band_sel" name=wl_band3 onChange="showtxrate_updated_virtual(document.MultipleAP, 3, virtual_wmm_enable[3], chanwid)">
				<script>
		...
		<td <% checkWrite("wlan_qtn_hidden_function"); %>>
			<!-- FIX: removed hardcoded width=60 -->
			<select class="txrate_sel" name="TxRate3">
				<script>
	...
	<tr>
		...
		<td id="wlan_band4" <% checkWrite("wlan_qtn_hidden_function"); %> >
			<!-- FIX: width:110px (was missing "px") -->
			<select class="band_sel" name=wl_band4 onChange="showtxrate_updated_virtual(document.MultipleAP, 4, virtual_wmm_enable[4], chanwid)">
				<script>
		...
		<td <% checkWrite("wlan_qtn_hidden_function"); %>>
			<!-- FIX: removed hardcoded width=60 -->
			<select class="txrate_sel" name="TxRate4">
				<script>
...
<div class="btn_ctl">
	...
	<input type="submit" value="<% multilang("169" "LANG_APPLY_CHANGES"); %>"  onClick="return saveChanges(document.MultipleAP, wlan_idx)" class="link_bg">&nbsp;&nbsp;
